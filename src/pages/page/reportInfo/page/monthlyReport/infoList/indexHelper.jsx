...
import { CycleTooltipStyle } from "./indexStyle";
      ...
      },
      {
        ...
        title: (
          <>
            ...
            (當日)
            <Tooltip
              className="tooltip-cycle"
              contentStyles={CycleTooltipStyle}
              title={
                <div className="cycle-tooltip-content">
                  Cycle = 全日放電量/案場建置容量
                  <br />
                  (SG 參考值 : 0.85 CYCLE / Day)
                </div>
              }
            />
          </>
