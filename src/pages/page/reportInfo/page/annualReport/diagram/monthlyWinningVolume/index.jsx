...
function MonthlyWinningVolume() {
  ...
  const {
    getMonthlyWinningVolumeOption,
    resizeChart,
    setMonthlyWinningVolumeChart,
    switchBarLineChart,
  } = useHelpers({
    refs: {
  ...
  const debounceElectricityUsageChart = useMemo(
    ...
    [resizeChart, setMonthlyWinningVolumeChart]
  );
  const monthlyWinningVolumeOption = getMonthlyWinningVolumeOption();
  ...
  useEffect(() => {
    if (
      ...
      setMonthlyWinningVolumeChart(monthlyWinningVolumeOption);
    }
  }, [monthlyWinningVolumeOption, setMonthlyWinningVolumeChart]);
    ...
    <ScopeStyle>
      <Card>
        ...
        <Flex
          ...
          justify="center"
        >
          {monthlyWinningVolumeOption.legend?.data?.map((item, index) => {
            return (
              <Flex
                align="center"
              ...
              >
                <span
                  ...
                  style={{
                    backgroundColor:
                      monthlyWinningVolumeOption?.series?.[index]?.itemStyle
                        ?.color,
                  }}
                ></span>
                <span>{item}</span>
...
export default MonthlyWinningVolume;
