      ...
      series: [
        {
          ...
          data: [95, 97, 100, 100, 97, 97, 95, 93, 94, 96, 100, 100],
        },
        {
          name: "max-min",
          type: "bar",
        ...
        },
        {
          ...
          data: [96, 98, 100, 100, 98, 98, 97, 96, 96, 97, 100, 100],
          itemStyle: {
            color: "transparent",
          },
          markPoint: {
      ...
      series: [
        {
          name: "max",
          type: "line",
          data: [100, 100, 100, 100, 100, 100, 100, 99, 99, 100, 100, 100],
          itemStyle: {
            color: color.lightBlue,
          },
          symbol: "none",
