  ...
  function getSbspmBarOption() {
    return {
      ...
      tooltip: {
        ...
        formatter: function (params) {
          ...
          <div class="chart-custom-tooltip">
            <div class="header-title">${params[0].axisValue}:00</div>  
            <div class="row">
              <div class="category">
      ...
      xAxis: {
        ...
        data: [...Array(24)].map((_item, index) => index),
      },
      yAxis: {
        type: "value",
        max: 100,
      ...
      tooltip: {
        ...
        formatter(params) {
          ...
          if (Array.isArray(params)) {
            let tooltipContent = `${params[0].axisValue}:00`;
      ...
      series: [
        {
          ...
          data: [
            ...
            100, 99, 98, 96, 97, 98, 97, 96, 96, 96,
          ],
          itemStyle: {
            color: color.lightBlue,
          },
