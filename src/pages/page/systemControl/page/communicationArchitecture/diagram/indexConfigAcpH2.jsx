...
const nodeSetting = {
  "acpmH2-1": {
    id: `${nodeGroupSetting.acpH2.id}:acpmH2-1`,
    name: "ACPM H2-1",
  },
  "acpmH2-2": {
    id: `${nodeGroupSetting.acpH2.id}:acpmH2-2`,
    name: "ACPM H2-2",
  },
  remoteIo: { id: `${nodeGroupSetting.acpH2.id}:remoteIo`, name: "Remote I/O" },
  trTemp: { id: `${nodeGroupSetting.acpH2.id}:trTemp`, name: "TR Temp" },
};
//設定線路資訊
const edgeSetting = {
  "acpH2:acpmH2-1-acpH2:acpmH2-2": {
    id: `${nodeSetting["acpmH2-1"].id}-to-${nodeSetting["acpmH2-2"].id}`,
  },
  "acpH2:remoteIo-lc1000H2:switch": {
    id: `${nodeSetting.remoteIo.id}-to-${indexConfigLc1000H2.nodeSetting.switch.id}`,
  },
};
//節點初始值設定
const initialNodes = [
  //group：ACP-H2
  {
    data: { label: nodeGroupSetting.acpH2.name },
    id: nodeGroupSetting.acpH2.id,
    position: { x: 4175, y: 24300 },
    style: {
      ...nodeGroupStyle,
      width: nodeGap - 10,
  ...
  //acpH2:TR Temp
  {
    ...
    parentNode: nodeGroupSetting.acpH2.id,
  ...
  //acpH2:ACPM H2-1
  {
    data: {
      label: (
        <NodeLabel
          label={nodeSetting["acpmH2-1"].name}
  ...
  //acpH2:ACPM H2-2
  {
    data: {
      label: (
        <NodeLabel
          label={nodeSetting["acpmH2-2"].name}
          labelStyle={{ left: "50%", whiteSpace: "nowrap" }}
        >
          <div className="rect-icon bg-auxm"></div>
        </NodeLabel>
...
const initialEdges = [
  {
    //acpH2:ACPM H2-1->ACPM H2-2
    id: edgeSetting["acpH2:acpmH2-1-acpH2:acpmH2-2"].id,
    source: nodeSetting["acpmH2-1"].id,
  ...
  },
  {
    ...
    id: edgeSetting["acpH2:remoteIo-lc1000H2:switch"].id,
    ...
    target: indexConfigLc1000H2.nodeSetting.switch.id,
