...
const nodeSetting = {
  "acpmD2-1": {
    id: `${nodeGroupSetting.acpD2.id}:acpmD2-1`,
    name: "ACPM D2-1",
  },
  "acpmD2-2": {
    id: `${nodeGroupSetting.acpD2.id}:acpmD2-2`,
    name: "ACPM D2-2",
  },
  remoteIo: { id: `${nodeGroupSetting.acpD2.id}:remoteIo`, name: "Remote I/O" },
  trTemp: { id: `${nodeGroupSetting.acpD2.id}:trTemp`, name: "TR Temp" },
};
//設定線路資訊
const edgeSetting = {
  "acpD2:acpmD2-1-acpD2:acpmD2-2": {
    id: `${nodeSetting["acpmD2-1"].id}-to-${nodeSetting["acpmD2-2"].id}`,
  },
  "acpD2:remoteIo-lc1000D2:switch": {
    id: `${nodeSetting.remoteIo.id}-to-${indexConfigLc1000D2.nodeSetting.switch.id}`,
  },
};
//節點初始值設定
const initialNodes = [
  //group：ACP-D2
  {
    data: { label: nodeGroupSetting.acpD2.name },
    id: nodeGroupSetting.acpD2.id,
    position: { x: 3800, y: 13900 },
    style: {
      ...nodeGroupStyle,
      width: nodeGap - 10,
  ...
  //acpD2:TR Temp
  {
    ...
    parentNode: nodeGroupSetting.acpD2.id,
  ...
  //acpD2:ACPM D2-1
  {
    data: {
      label: (
        <NodeLabel
          label={nodeSetting["acpmD2-1"].name}
  ...
  //acpD2:ACPM D2-2
  {
    data: {
      label: (
        <NodeLabel
          label={nodeSetting["acpmD2-2"].name}
          labelStyle={{ left: "50%", whiteSpace: "nowrap" }}
        >
          <div className="rect-icon bg-auxm"></div>
        </NodeLabel>
...
const initialEdges = [
  {
    //acpD2:ACPM D2-1->ACPM D2-2
    id: edgeSetting["acpD2:acpmD2-1-acpD2:acpmD2-2"].id,
    source: nodeSetting["acpmD2-1"].id,
  ...
  },
  {
    ...
    id: edgeSetting["acpD2:remoteIo-lc1000D2:switch"].id,
    ...
    target: indexConfigLc1000D2.nodeSetting.switch.id,
